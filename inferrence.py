...
model = LitClassificationModel.load_from_checkpoint(checkpoint,backbone=arglist['-bb'],head=arglist['-he'],criterion_name=arglist['--criterion_name'],framestep=int(arglist['--framestep']),embedding='False',img_size=int(256))
